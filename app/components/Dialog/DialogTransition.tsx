...
export const DialogTransition: FC<IDialogTransition> = (props) => {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-20" initialFocus={initialFocus} onClose={() => null}>
        ...
        <div className="scrollbar-hide fixed inset-0 z-10 h-full min-h-screen overflow-auto overscroll-auto">
